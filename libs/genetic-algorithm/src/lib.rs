...
// Allows us to index from our Chromosome -> chromosome["hello!"]
...
// Allows us to convert (collect) an iterator of Type into some other thing. In this case f32s into a Chromosome
...
// Allows us to convert a type into an iterator (convert Chromosome into an iterator of its genes)
...
// TODO: instead of UniformCross over, try to make your own version of another crossover algorithm
...
mod tests {
    ...
    enum TestIndividual {
        /// For tests that require access to a chromosome
        WithChromosome { chromosome: Chromosome },

        /// For tests that don't require access to a chromosome
        ...
        mod given_max_chance {
            ...
            mod and_nonzero_coefficient {
                ...
                fn entirely_changes_the_original_chromosome() {
                    let actual = actual(1.3);
                    let expected = vec![2.1817818, 2.3021405, 2.4166245, 3.8713324, 4.060597];
